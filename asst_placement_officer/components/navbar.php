<?php
session_start();
$base_url = "https://jntuacep.ac.in/placement_cell/asst_placement_officer";
?>
...
<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p><b>Admin : <?php echo $_SESSION['asst_pl_officer_name']; ?></b></p>
            ...
            <ul class="list-unstyled CTAs">
                ...
                <form action="code.php" method="POST">
                    <button class="profile-btn py-2" type="submit" name="asst_pl_officer_logout"><i class=" fa fa-power"></i>&nbsp;LOGOUT</button>
                </form>
                </li>
            </ul>
        </nav>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item">
                            <form action="code.php" method="POST">
                                <button class="btn button-white py-2" type="submit" name="asst_pl_officer_logout"><i class="fa fa-power"></i>&nbsp;LOGOUT</button>
                            </form>
                            </li>
                        </ul>
                    </div>
